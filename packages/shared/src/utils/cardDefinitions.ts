...
export const CARD_DECKS: CardDeckDefinitions = {
  ...
  [GameMode.PRIVACY]: {
    A: {
      name: 'Spoofing',
      abbreviation: 'S',
      cards: ['A2','A3','A4','A5','A6','A7','A8','A9','A10','AJ','AQ','AK','AA','AE'],
      isTrump: false,
      isDefault: false,
    },
    B: {
    ...
    C: {
      name: 'Repudiation',
      abbreviation: 'R',
      cards: ['C2','C3','C4','C5','C6','C7','C8','C9','C10','CJ','CQ','CK','CA','CE','CF','CG','CH'],
      isTrump: false,
      isDefault: false,
    },
    D: {
      name: 'Information Disclosure',
      abbreviation: 'I',
      cards: ['D2','D3','D4','D5','D6','D7','D8','D9','D10','DJ','DQ','DK','DA','DE','DF'],
      isTrump: false,
      isDefault: false,
    },
    E: {
      name: 'Denial of Service',
      abbreviation: 'DoS',
      cards: ['E2','E3','E4','E5','E6','E7','E8','E9','E10','EJ','EQ','EK','EA','EE'],
      isTrump: false,
      isDefault: false,
    },
    F: {
      name: 'Elevation of Privilege',
      abbreviation: 'EoP',
      cards: ['F2','F3','F4','F5','F6','F7','F8','F9','F10','FJ','FQ','FK','FA'],
      isTrump: false,
      isDefault: false,
    },
    G: {
      name: 'Transfer',
      abbreviation: 'TR',
      cards: ['G2','G3','G4','G5','G6','G7','G8','G9','GA'],
      isTrump: false,
      isDefault: false,
    },
    H: {
      name: 'Retention',
      abbreviation: 'RE',
      cards: ['H2','H3','H4','H5','H6','H7','H8','H9','H10','HJ','HA'],
      isTrump: false,
      isDefault: false,
    },
    I: {
      name: 'Inference',
      abbreviation: 'INF',
      cards: ['I2','I3','I4','I5','I6','I7','I8','I9','I10','IA'],
      isTrump: false,
      isDefault: false,
    },
    J: {
