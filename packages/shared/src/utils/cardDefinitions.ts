...
export const CARD_DECKS: CardDeckDefinitions = {
  [GameMode.EOP]: {
    A: { name: 'Denial of Service', abbreviation: 'D', cards: ['A2','A3','A4','A5','A6','A7','A8','A9','A10','AJ','AQ','AK','AA'], isTrump: false, isDefault: false },
    B: { name: 'Information Disclosure', abbreviation: 'I', cards: ['B2','B3','B4','B5','B6','B7','B8','B9','B10','BJ','BQ','BK','BA'], isTrump: false, isDefault: false },
    C: { name: 'Repudiation', abbreviation: 'R', cards: ['C2','C3','C4','C5','C6','C7','C8','C9','C10','CJ','CQ','CK','CA'], isTrump: false, isDefault: false },
    D: { name: 'Spoofing', abbreviation: 'S', cards: ['D2','D3','D4','D5','D6','D7','D8','D9','D10','DJ','DQ','DK','DA'], isTrump: false, isDefault: false },
    E: { name: 'Tampering', abbreviation: 'T', cards: ['E2','E3','E4','E5','E6','E7','E8','E9','E10','EJ','EQ','EK','EA'], isTrump: false, isDefault: true },
    T: { name: 'Elevation of Privilege', abbreviation: 'E', cards: ['T2','T3','T4','T5','T6','T7','T8','T9','T10','TJ','TQ','TK','TA'], isTrump: true, isDefault: false },
  },
  [GameMode.PRIVACY]: {
  ...
  [GameMode.CORNUCOPIA]: {
    A: { name: 'Data Validation & Encoding', abbreviation: 'Data', cards: ['A2','A3','A4','A5','A6','A7','A8','A9','A10','AJ','AQ','AK','AA'], isTrump: false, isDefault: false },
    B: { name: 'Cryptography', abbreviation: 'Crypt', cards: ['B2','B3','B4','B5','B6','B7','B8','B9','B10','BJ','BQ','BK','BA'], isTrump: false, isDefault: false },
    C: { name: 'Session Management', abbreviation: 'Sessn', cards: ['C2','C3','C4','C5','C6','C7','C8','C9','C10','CJ','CQ','CK','CA'], isTrump: false, isDefault: false },
    D: { name: 'Authorization', abbreviation: 'AuthZ', cards: ['D2','D3','D4','D5','D6','D7','D8','D9','D10','DJ','DQ','DK','DA'], isTrump: false, isDefault: false },
    E: { name: 'Authentication', abbreviation: 'AuthN', cards: ['E2','E3','E4','E5','E6','E7','E8','E9','E10','EJ','EQ','EK','EA'], isTrump: false, isDefault: true },
    T: { name: 'Cornucopia', abbreviation: 'Cornu', cards: ['T2','T3','T4','T5','T6','T7','T8','T9','T10','TJ','TQ','TK','TA'], isTrump: true, isDefault: false },
  },
  [GameMode.CUMULUS]: {
    A: { name: 'Resources', abbreviation: 'Res', cards: ['A4','A5','A6','A7','A8','A9','A10','AJ','AQ','AK','AA'], isTrump: false, isDefault: false },
    B: { name: 'Monitoring', abbreviation: 'Mon', cards: ['B5','B6','B7','B8','B9','B10','BJ','BQ','BK','BA'], isTrump: false, isDefault: false },
    C: { name: 'Recovery', abbreviation: 'Rec', cards: ['C3','C4','C5','C6','C7','C8','C9','C10','CJ','CQ','CK','CA'], isTrump: false, isDefault: false },
    D: { name: 'Delivery', abbreviation: 'Del', cards: ['D2','D3','D4','D5','D6','D7','D8','D9','D10','DJ','DQ','DK','DA'], isTrump: false, isDefault: false },
    E: { name: undefined, abbreviation: undefined, cards: [], isTrump: false, isDefault: false },
    T: { name: 'Access & Secrets', abbreviation: 'XsSec', cards: ['T2','T3','T4','T5','T6','T7','T8','T9','T10','TJ','TQ','TK','TA'], isTrump: true, isDefault: true },
  },
  [GameMode.EOMLSEC]: {
    A: { name: 'Model Risk', abbreviation: 'Mod', cards: ['A2','A3','A4','A5','A6','A7','A8','A9','A10','AJ','AQ','AK','AA'], isTrump: false, isDefault: true },
    B: { name: 'Input Risk', abbreviation: 'In', cards: ['B2','B3','B4','B5','B6','B7','B8','B9','B10','BJ','BQ','BK','BA'], isTrump: false, isDefault: false },
    C: { name: 'Output Risk', abbreviation: 'Out', cards: ['C2','C3','C4','C5','C6','C7','C8','C9','C10','CJ','CQ','CK','CA'], isTrump: false, isDefault: false },
    D: { name: '', abbreviation: '', cards: [], isTrump: false, isDefault: false },
    E: { name: '', abbreviation: '', cards: [], isTrump: false, isDefault: false },
    T: { name: 'Dataset Risk', abbreviation: 'Data', cards: ['T2','T3','T4','T5','T6','T7','T8','T9','T10','TJ','TQ','TK','TA'], isTrump: true, isDefault: false },
  },
};
